...
CREATE TABLE `OrderItem` (
    ...
    `thread_one` VARCHAR(191) NOT NULL DEFAULT 'no color',
    `thread_two` VARCHAR(191) NOT NULL DEFAULT 'no color',
    `name_on` VARCHAR(191) NULL,
...
CREATE TABLE `Order` (
    ...
    `buyer_state` VARCHAR(191) NOT NULL,
    ...
    `status` ENUM('confirmed', 'cancelled', 'delivered', 'pending') NOT NULL DEFAULT 'pending',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
